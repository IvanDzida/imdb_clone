...
class MovieDetail {
  ...
  MovieDetail.fromJson(Map<String, dynamic> json){
    ...
    budget = json['budget'];
    genres = List.from(json['genres']).map((e)=>Genre.fromMap(e)).toList();
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['budget'] = budget;
    _data['genres'] = genres.map((e)=>e.toMap()).toList();
    ...
    _data['spoken_languages'] = spokenLanguages.map((e)=>e).toList();
    _data['status'] = status;
